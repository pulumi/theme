...
`,Aa=(class extends it{}.compose({baseName:"tab-panel",template:Ea,styles:Ma}),Ma);xa.compose({baseName:"tabs",template:Sa,styles:(e,t)=>go`
    ...
    `});function Na(e){return Fo(e)&&"treeitem"===e.getAttribute("role")}class Da extends it{constructor(){super(...arguments),this.expanded=!1,this.focusable=!1,this.handleExpandCollapseButtonClick=e=>{this.disabled||(e.preventDefault(),this.setExpanded(!this.expanded))},this.handleClick=e=>{if(!e.defaultPrevented){const t=e.composedPath().find((e=>e instanceof HTMLElement&&Na(e)));return t===this&&this.handleSelected(),!0}},this.isNestedItem=()=>Na(this.parentElement)}itemsChanged(e,t){this.$fastController.isConnected&&this.items.forEach((e=>{Na(e)&&(e.nested=!0)}))}static focusItem(e){e.focusable=!0,e.focus()}childItemLength(){const e=this.childItems.filter((e=>Na(e)));return e?e.length:0}handleSelected(e){this.$emit("selected-change",e)}setExpanded(e){this.expanded=e,this.$emit("expanded-change",this)}}e([G({mode:"boolean"})],Da.prototype,"expanded",void 0),e([G({mode:"boolean"})],Da.prototype,"selected",void 0),e([G({mode:"boolean"})],Da.prototype,"disabled",void 0),e([M],Da.prototype,"focusable",void 0),e([M],Da.prototype,"childItems",void 0),e([M],Da.prototype,"items",void 0),e([M],Da.prototype,"nested",void 0),e([M],Da.prototype,"renderCollapsedChildren",void 0),qi(Da,zi);class Pa extends it{constructor(){super(...arguments),this.handleBlur=e=>{const{relatedTarget:t,target:n}=e;n instanceof HTMLElement&&(null===t||!this.contains(t))&&this.setAttribute("tabindex","0")},this.handleFocus=e=>{const{relatedTarget:t,target:n}=e;if(n instanceof HTMLElement&&(null===t||!this.contains(t))){const e=this;n===this&&this.currentFocused instanceof Da&&(Da.focusItem(this.currentFocused),this.currentFocused.setAttribute("tabindex","0")),e.setAttribute("tabindex","-1")}},this.handleKeyDown=e=>{if(!this.treeItems)return!0;switch(e.key){case Ji:this.treeItems&&this.treeItems.length&&(Da.focusItem(this.treeItems[0]),this.treeItems[0].setAttribute("tabindex","0"));break;case Qi:this.treeItems&&this.treeItems.length&&(Da.focusItem(this.treeItems[this.treeItems.length-1]),this.treeItems[this.treeItems.length-1].setAttribute("tabindex","0"));break;case Yi:if(e.target&&this.isFocusableElement(e.target)){const t=e.target;t instanceof Da&&t.childItemLength()>0&&(t.expanded=!1)}break;case Ki:if(e.target&&this.isFocusableElement(e.target)){const t=e.target;t instanceof Da&&t.childItemLength()>0&&(t.expanded=!0)}break;case Gi:e.target&&this.isFocusableElement(e.target)&&this.focusNextNode(1,e.target);break;case Xi:e.target&&this.isFocusableElement(e.target)&&this.focusNextNode(-1,e.target);break;case Zi:this.handleSelected(e.target);break;default:return!0}},this.setItems=()=>{let e=this.treeItems.findIndex(this.isSelectedElement);-1===e&&(e=this.treeItems.findIndex(this.isFocusableElement));for(let t=0;t<this.treeItems.length;t++)t===e&&(this.treeItems[t].setAttribute("tabindex","0"),this.currentFocused=this.treeItems[t]),this.treeItems[t].addEventListener("selected-change",this.handleItemSelected)},this.resetItems=()=>{for(let e=0;e<this.treeItems.length;e++)this.treeItems[e].removeEventListener("selected-change",this.handleItemSelected)},this.handleItemSelected=e=>{const t=e.target;t!==this.currentSelected&&this.handleSelected(t)},this.isFocusableElement=e=>Na(e),this.isSelectedElement=e=>e.selected}slottedTreeItemsChanged(e,t){this.$fastController.isConnected&&(this.resetItems(),this.treeItems=this.getVisibleNodes(),this.setItems(),this.checkForNestedItems()&&this.slottedTreeItems.forEach((e=>{Na(e)&&(e.nested=!0)})))}checkForNestedItems(){return this.slottedTreeItems.some((e=>Na(e)&&e.querySelector("[role='treeitem']")))}connectedCallback(){super.connectedCallback(),this.treeItems=this.getVisibleNodes(),g.queueUpdate((()=>{const e=this.treeView.querySelector("[aria-selected='true']");e&&(this.currentSelected=e)}))}focusNextNode(e,t){const n=this.getVisibleNodes();if(!n)return;const r=n.indexOf(t),i=n[r];(e<0&&r>0||e>0&&r<n.length-1)&&i.setAttribute("tabindex","-1");const o=n[n.indexOf(t)+e];Fo(o)&&(Da.focusItem(o),o.setAttribute("tabindex","0"),this.currentFocused=o)}handleSelected(e){this.currentSelected!==e&&(e.setAttribute("tabindex","0"),this.currentSelected instanceof Da&&this.currentFocused&&(e.disabled||(this.currentSelected.selected=!1),this.currentFocused.setAttribute("tabindex","-1")),this.currentSelected||this.slottedTreeItems.forEach((e=>{e instanceof Da&&e.setAttribute("tabindex","-1")})),e.disabled||(e.selected=!0,this.currentSelected=e),this.currentFocused=e)}getVisibleNodes(){return function(e,t){if(!Fo(e))return;return Array.from(e.querySelectorAll(t)).filter((e=>null!==e.offsetParent))}(this,"[role='treeitem']")||[]}}e([G({attribute:"render-collapsed-nodes"})],Pa.prototype,"renderCollapsedNodes",void 0),e([M],Pa.prototype,"currentSelected",void 0),e([M],Pa.prototype,"nested",void 0),e([M],Pa.prototype,"slottedTreeItems",void 0);const Fa=(e,t)=>ji`
    <template
        role="tree"
        ${Bi("treeView")}

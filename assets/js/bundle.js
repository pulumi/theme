...
`.withBehaviors(wo(go`
    ...
    :host([appearance="hypertext"]) .control:visited {
        background: transparent;
        color: ${Dr};
        border-bottom: calc(${_n} * 1px) solid ${Dr};
    }
...
`,Ms="box-shadow: 0 0 calc((var(--elevation) * 0.225px) + 2px) rgba(0, 0, 0, calc(.11 * (2 - var(--background-luminance, 1)))), 0 calc(var(--elevation) * 0.4px) calc((var(--elevation) * 0.9px)) rgba(0, 0, 0, calc(.13 * (2 - var(--background-luminance, 1))));",As=(e,t)=>go`
    ...
    `.withBehaviors(wo(go`
            ...
            `));(class extends Is{connectedCallback(){super.connectedCallback();const e=ie(this);e&&yr.setValueFor(this,(t=>Zr.getValueFor(t).evaluate(t,yr.getValueFor(e))))}}).compose({baseName:"card",baseClass:Is,template:Ls,styles:As});const Ns=As;Is.compose({baseName:"card",template:Ls,styles:Ns});class Ds extends it{constructor(){super(...arguments),this.appearance="",this.count=0}increment(){this.count++}}e([G],Ds.prototype,"appearance",void 0),e([G],Ds.prototype,"count",void 0);Ds.compose({baseName:"counter",template:(e,t)=>{const n=e.tagFor(Ko);return ji`
...
`,Aa=(class extends it{}.compose({baseName:"tab-panel",template:Ea,styles:Ma}),Ma);xa.compose({baseName:"tabs",template:Sa,styles:(e,t)=>go`
    ...
    `});function Na(e){return Fo(e)&&"treeitem"===e.getAttribute("role")}class Da extends it{constructor(){super(...arguments),this.expanded=!1,this.focusable=!1,this.enabledChildTreeItems=[],this.handleKeyDown=e=>{if(e.target!==e.currentTarget)return!0;switch(e.key){case Yi:e.preventDefault(),this.collapseOrFocusParent();break;case Ki:e.preventDefault(),this.expandOrFocusFirstChild();break;case Gi:e.preventDefault(),this.focusNextNode(1);break;case Xi:e.preventDefault(),this.focusNextNode(-1);break;case Zi:this.handleSelected(e)}return!0},this.handleExpandCollapseButtonClick=e=>{this.disabled||(e.preventDefault(),this.setExpanded(!this.expanded))},this.handleClick=e=>{e.defaultPrevented||this.disabled||this.handleSelected(e)},this.isNestedItem=()=>Na(this.parentElement)}itemsChanged(e,t){this.$fastController.isConnected&&(this.items.forEach((e=>{Na(e)&&(e.nested=!0)})),this.enabledChildTreeItems=this.items.filter((e=>Na(e)&&!e.hasAttribute("disabled"))))}getParentTreeNode(){return this.parentElement.closest("[role='tree']")}connectedCallback(){super.connectedCallback();const e=this.getParentTreeNode();e&&(e.hasAttribute("render-collapsed-nodes")&&(this.renderCollapsedChildren="true"===e.getAttribute("render-collapsed-nodes")),this.notifier=O.getNotifier(e),this.notifier.subscribe(this,"renderCollapsedNodes"))}disconnectedCallback(){super.disconnectedCallback(),this.notifier&&this.notifier.unsubscribe(this,"renderCollapsedNodes")}static focusItem(e){e.setAttribute("tabindex","0"),e.focusable=!0,e.focus()}handleChange(e,t){if("renderCollapsedNodes"===t)this.renderCollapsedChildren=e.renderCollapsedNodes}childItemLength(){const e=this.childItems.filter((e=>Na(e)));return e?e.length:0}collapseOrFocusParent(){if(this.expanded)this.setExpanded(!1);else if(Fo(this.parentElement)){const e=this.parentElement.closest("[role='treeitem']");Fo(e)&&Da.focusItem(e)}}expandOrFocusFirstChild(){"boolean"==typeof this.expanded&&(!this.expanded&&this.childItemLength()>0?this.setExpanded(!0):this.enabledChildTreeItems.length>0&&Da.focusItem(this.enabledChildTreeItems[0]))}focusNextNode(e){const t=this.getVisibleNodes();if(!t)return;const n=t.indexOf(this);if(-1!==n){let r=t[n+e];if(void 0!==r)for(;r.hasAttribute("disabled");){if(r=t[n+e+(e>=0?1:-1)],!r)break}Fo(r)&&Da.focusItem(r)}}getVisibleNodes(){return function(e,t){if(!Fo(e))return;return Array.from(e.querySelectorAll(t)).filter((e=>null!==e.offsetParent))}(this.getTreeRoot(),"[role='treeitem']")}getTreeRoot(){return Fo(this)?this.closest("[role='tree']"):null}handleSelected(e){this.selected=!this.selected,this.$emit("selected-change",e)}setExpanded(e){this.expanded=e,this.$emit("expanded-change",this)}}e([G({mode:"boolean"})],Da.prototype,"expanded",void 0),e([G({mode:"boolean"})],Da.prototype,"selected",void 0),e([G({mode:"boolean"})],Da.prototype,"disabled",void 0),e([M],Da.prototype,"focusable",void 0),e([M],Da.prototype,"childItems",void 0),e([M],Da.prototype,"items",void 0),e([M],Da.prototype,"nested",void 0),e([M],Da.prototype,"renderCollapsedChildren",void 0),qi(Da,zi);class Pa extends it{constructor(){super(...arguments),this.handleBlur=e=>{const{relatedTarget:t,target:n}=e;t instanceof HTMLElement&&n instanceof HTMLElement&&this.contains(t)&&n.removeAttribute("tabindex")},this.handleKeyDown=e=>{if(!this.treeItems)return!0;switch(e.key){case Ji:this.treeItems&&this.treeItems.length&&Da.focusItem(this.treeItems[0]);break;case Qi:this.treeItems&&this.treeItems.length&&Da.focusItem(this.treeItems[this.treeItems.length-1]);break;default:return!0}},this.setItems=()=>{const e=this.treeItems.findIndex(this.isFocusableElement);for(let t=0;t<this.treeItems.length;t++)t!==e||this.treeItems[t].hasAttribute("disabled")||this.treeItems[t].setAttribute("tabindex","0"),this.treeItems[t].addEventListener("selected-change",this.handleItemSelected)},this.resetItems=()=>{for(let e=0;e<this.treeItems.length;e++)this.treeItems[e].removeEventListener("selected-change",this.handleItemSelected)},this.handleItemSelected=e=>{const t=e.target;t!==this.currentSelected&&(this.currentSelected&&(this.currentSelected.removeAttribute("selected"),this.currentSelected.selected=!1),this.currentSelected=t)},this.isFocusableElement=e=>Na(e)&&!this.isDisabledElement(e),this.isDisabledElement=e=>Na(e)&&"true"===e.getAttribute("aria-disabled")}slottedTreeItemsChanged(e,t){this.$fastController.isConnected&&(this.resetItems(),this.treeItems=this.getVisibleNodes(),this.setItems(),this.checkForNestedItems()&&this.slottedTreeItems.forEach((e=>{Na(e)&&(e.nested=!0)})))}checkForNestedItems(){return this.slottedTreeItems.some((e=>Na(e)&&e.querySelector("[role='treeitem']")))}connectedCallback(){super.connectedCallback(),this.treeItems=this.getVisibleNodes(),g.queueUpdate((()=>{const e=this.treeView.querySelector("[aria-selected='true']");e&&(this.currentSelected=e)}))}getVisibleNodes(){const e=[];return void 0!==this.slottedTreeItems&&this.slottedTreeItems.forEach((t=>{Na(t)&&e.push(t)})),e}}e([G({attribute:"render-collapsed-nodes"})],Pa.prototype,"renderCollapsedNodes",void 0),e([M],Pa.prototype,"currentSelected",void 0),e([M],Pa.prototype,"nested",void 0),e([M],Pa.prototype,"slottedTreeItems",void 0);const Fa=(e,t)=>ji`
    <template
        role="tree"
        ${Bi("treeView")}
...
`,Ua=mo`((${$n} / 2) * ${kn}) + ((${kn} * ${Sn}) / 2)`,Ga=me.create("tree-item-expand-collapse-hover").withDefault((e=>{const t=Ur.getValueFor(e);return t.evaluate(e,t.evaluate(e).hover).hover})),Ya=me.create("tree-item-expand-collapse-selected-hover").withDefault((e=>{const t=Vr.getValueFor(e);return Ur.getValueFor(e).evaluate(e,t.evaluate(e).rest).hover})),Ka=(e,t)=>go`
    ${xo("block")} :host {
        contain: content;
        position: relative;
        outline: none;

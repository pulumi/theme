...
`,Cs=(e,t)=>go`
    ...
    `,ks=(ws.compose({baseName:"accordion",template:$s,styles:Cs}),Cs),Ss=(e,t)=>go`
    ${xo("flex")} :host {
        box-sizing: border-box;
        font-family: ${wn};
        flex-direction: column;
    ...
    .start {
        display: flex;
        align-items: center;
        padding-inline-start: calc(${Sn} * 1px);
        justify-content: center;
        grid-column: 1;
        z-index: 2;
    }
...
`,Rs=(e,t)=>go`
    ...
    .control {
        position: relative;
        width: calc((${Ro} / 2 + ${Sn}) * 1px);
        height: calc((${Ro} / 2 + ${Sn}) * 1px);
        box-sizing: border-box;
        border-radius: calc(${Cn} * 1px);
...
`;class Sa extends it{}e([G({mode:"boolean"})],Sa.prototype,"disabled",void 0);const Ta=(e,t)=>ji`
...
`,_a=(e,t)=>go`
        ...
        .tablist {
            ...
            width: max-content;
            align-self: end;
            padding: calc(${Sn} * 4px) calc(${Sn} * 4px) 0;
            box-sizing: border-box;
        }
        ...
        :host([orientation="vertical"]) .tablist {
            ...
            justify-self: end;
            width: 100%;
            padding: calc((${Ro} - ${Sn}) * 1px)
                calc(${Sn} * 4px) calc((${Ro} - ${Sn}) * 1px) 0;
        }
    ...
    `.withBehaviors(wo(go`
            ...
            `)),Oa=(xa.compose({baseName:"tabs",template:ka,styles:_a}),_a),Ia=(e,t)=>go`
    ${xo("inline-flex")} :host {
        box-sizing: border-box;
        font-family: ${wn};
        font-size: ${In};
        line-height: ${Ln};
        height: calc(${Ro} * 1px);
        padding: calc(${Sn} * 5px) calc(${Sn} * 4px);
        color: ${ri};
        fill: currentcolor;
        border-radius: calc(${Cn} * 1px);
        border: calc(${_n} * 1px) solid transparent;
...
`.withBehaviors(wo(go`
        ...
        `)),La=(Sa.compose({baseName:"tab",template:Ta,styles:Ia}),Ia);const Ma=(e,t)=>go`
    ${xo("block")} :host {
        box-sizing: border-box;
        font-size: ${In};
        line-height: ${Ln};
...
`,Aa=(class extends it{}.compose({baseName:"tab-panel",template:Ea,styles:Ma}),Ma);xa.compose({baseName:"tabs",template:ka,styles:(e,t)=>go`
        ${Oa(e,t)}
    ...
    `}),Sa.compose({baseName:"tab",template:Ta,styles:(e,t)=>go`
        ${La(e,t)}
...
`,Ua=vo`((${$n} / 2) * ${Sn}) + ((${Sn} * ${kn}) / 2)`,Ga=ve.create("tree-item-expand-collapse-hover").withDefault((e=>{const t=Ur.getValueFor(e);return t.evaluate(e,t.evaluate(e).hover).hover})),Ya=ve.create("tree-item-expand-collapse-selected-hover").withDefault((e=>{const t=Vr.getValueFor(e);return Ur.getValueFor(e).evaluate(e,t.evaluate(e).rest).hover})),Ka=(e,t)=>go`
    ${xo("block")} :host {
        contain: content;
        position: relative;
        outline: none;
    ...
    .content-region {
        ...
        width: 100%;
        height: calc(${Ro} * 1px);
        margin-inline-start: calc(${Sn} * 2px + 8px);
        font-size: ${In};
        line-height: ${Ln};
        font-weight: 400;
    }
    ...
    .expand-collapse-button {
        ...
        outline: none;
        /* TODO: adaptive typography https://github.com/microsoft/fast/issues/2432 */
        width: calc((${Ua} + (${Sn} * 2)) * 1px);
        height: calc((${Ua} + (${Sn} * 2)) * 1px);
        padding: 0;
        display: flex;
        justify-content: center;
        align-items: center;
    ...
    .end {
        /* TODO: horizontalSpacing https://github.com/microsoft/fast/issues/2766 */
        margin-inline-start: calc(${Sn} * 2px + 2px);
    }

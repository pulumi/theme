...
declare global {
  interface HTMLPulumiApiDocFilterableNavElement
    extends Components.PulumiApiDocFilterableNav,
      HTMLStencilElement {}
  ...
  interface HTMLPulumiFilterSelectOptionGroupElement
    extends Components.PulumiFilterSelectOptionGroup,
      HTMLStencilElement {}
  ...
  interface HTMLPulumiGreenhouseJobsListElement
    extends Components.PulumiGreenhouseJobsList,
      HTMLStencilElement {}
  ...
  interface HTMLPulumiHubspotFormElement
    extends Components.PulumiHubspotForm,
      HTMLStencilElement {}
  var HTMLPulumiHubspotFormElement: {
    prototype: HTMLPulumiHubspotFormElement;
    new (): HTMLPulumiHubspotFormElement;
  };
  interface HTMLPulumiInstallElement
    extends Components.PulumiInstall,
      HTMLStencilElement {}
  var HTMLPulumiInstallElement: {
    prototype: HTMLPulumiInstallElement;
    new (): HTMLPulumiInstallElement;
  };
  interface HTMLPulumiMultiSelectFormElement
    extends Components.PulumiMultiSelectForm,
      HTMLStencilElement {}
...
declare module "@stencil/core" {
  export namespace JSX {
    interface IntrinsicElements {
      "pulumi-api-doc-filterable-nav": LocalJSX.PulumiApiDocFilterableNav &
        JSXBase.HTMLAttributes<HTMLPulumiApiDocFilterableNavElement>;
      "pulumi-api-doc-nav-node": LocalJSX.PulumiApiDocNavNode &
        JSXBase.HTMLAttributes<HTMLPulumiApiDocNavNodeElement>;
      "pulumi-api-doc-nav-tree": LocalJSX.PulumiApiDocNavTree &
        JSXBase.HTMLAttributes<HTMLPulumiApiDocNavTreeElement>;
      "pulumi-audio": LocalJSX.PulumiAudio &
        JSXBase.HTMLAttributes<HTMLPulumiAudioElement>;
      "pulumi-banner": LocalJSX.PulumiBanner &
        JSXBase.HTMLAttributes<HTMLPulumiBannerElement>;
      "pulumi-choosable": LocalJSX.PulumiChoosable &
        JSXBase.HTMLAttributes<HTMLPulumiChoosableElement>;
      "pulumi-chooser": LocalJSX.PulumiChooser &
        JSXBase.HTMLAttributes<HTMLPulumiChooserElement>;
      "pulumi-contact-us-form": LocalJSX.PulumiContactUsForm &
        JSXBase.HTMLAttributes<HTMLPulumiContactUsFormElement>;
      "pulumi-convert": LocalJSX.PulumiConvert &
        JSXBase.HTMLAttributes<HTMLPulumiConvertElement>;
      "pulumi-date-countdown": LocalJSX.PulumiDateCountdown &
        JSXBase.HTMLAttributes<HTMLPulumiDateCountdownElement>;
      "pulumi-datetime": LocalJSX.PulumiDatetime &
        JSXBase.HTMLAttributes<HTMLPulumiDatetimeElement>;
      "pulumi-example": LocalJSX.PulumiExample &
        JSXBase.HTMLAttributes<HTMLPulumiExampleElement>;
      "pulumi-examples": LocalJSX.PulumiExamples &
        JSXBase.HTMLAttributes<HTMLPulumiExamplesElement>;
      "pulumi-filter-select": LocalJSX.PulumiFilterSelect &
        JSXBase.HTMLAttributes<HTMLPulumiFilterSelectElement>;
      "pulumi-filter-select-option": LocalJSX.PulumiFilterSelectOption &
        JSXBase.HTMLAttributes<HTMLPulumiFilterSelectOptionElement>;
      "pulumi-filter-select-option-group": LocalJSX.PulumiFilterSelectOptionGroup &
        JSXBase.HTMLAttributes<HTMLPulumiFilterSelectOptionGroupElement>;
      "pulumi-greenhouse-jobs-list": LocalJSX.PulumiGreenhouseJobsList &
        JSXBase.HTMLAttributes<HTMLPulumiGreenhouseJobsListElement>;
      "pulumi-hubspot-form": LocalJSX.PulumiHubspotForm &
        JSXBase.HTMLAttributes<HTMLPulumiHubspotFormElement>;
      "pulumi-install": LocalJSX.PulumiInstall &
        JSXBase.HTMLAttributes<HTMLPulumiInstallElement>;
      "pulumi-multi-select-form": LocalJSX.PulumiMultiSelectForm &
        JSXBase.HTMLAttributes<HTMLPulumiMultiSelectFormElement>;
      "pulumi-root": LocalJSX.PulumiRoot &
        JSXBase.HTMLAttributes<HTMLPulumiRootElement>;
      "pulumi-slot-machine": LocalJSX.PulumiSlotMachine &
        JSXBase.HTMLAttributes<HTMLPulumiSlotMachineElement>;
      "pulumi-swipeable": LocalJSX.PulumiSwipeable &
        JSXBase.HTMLAttributes<HTMLPulumiSwipeableElement>;
      "pulumi-swiper": LocalJSX.PulumiSwiper &
        JSXBase.HTMLAttributes<HTMLPulumiSwiperElement>;
      "pulumi-tooltip": LocalJSX.PulumiTooltip &
        JSXBase.HTMLAttributes<HTMLPulumiTooltipElement>;
      "pulumi-top-button": LocalJSX.PulumiTopButton &
        JSXBase.HTMLAttributes<HTMLPulumiTopButtonElement>;
      "pulumi-webinar-form-select": LocalJSX.PulumiWebinarFormSelect &
        JSXBase.HTMLAttributes<HTMLPulumiWebinarFormSelectElement>;
    }
  }
}
